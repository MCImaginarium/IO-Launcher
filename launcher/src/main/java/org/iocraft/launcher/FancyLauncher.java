...
import org.iocraft.launcher.auth.AccountList;
import org.iocraft.launcher.auth.LoginService;
import org.iocraft.launcher.auth.YggdrasilLoginService;
import org.iocraft.launcher.dialog.LauncherFrame;
import org.iocraft.launcher.launch.LaunchSupervisor;
...
import org.iocraft.launcher.update.UpdateManager;
import org.iocraft.launcher.util.HttpRequest;
import org.iocraft.launcher.util.SharedLocale;
import org.iocraft.launcher.util.SimpleLogFormatter;
...
public final class FancyLauncher {
    ...
    public FancyLauncher(@NonNull File baseDir, @NonNull File configDir) throws IOException {
        SharedLocale.loadBundle("org.iocraft.launcher.lang.Launcher", Locale.getDefault());

        this.baseDir = baseDir;
        this.properties = LauncherUtils.loadProperties(FancyLauncher.class, "launcher.properties", "org.iocraft.launcher.propertiesFile");
    ...
    public static void main(final String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
	        ...
	        try {
                    ...
                    if (!SwingHelper.setLookAndFeel("org.iocraft.launcher.skin.LauncherLookAndFeel")) {
